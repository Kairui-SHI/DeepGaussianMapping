...
def MME():
    ...
    # np.savez('pcd_save/mean_map_entropy_replica.npz', est_entropies=est_entropies, est_mme=est_mme)
    ...
    data = np.load('pcd_save/mean_map_entropy.npz')
    data2 = np.load('pcd_save/mean_map_entropy_replica.npz')
    est_entropies = data2['est_entropies']
    # gt_entropies = data['gt_entropies']
    init_entropies = data['init_entropies']
    est_mme = data2['est_mme']
    # gt_mme = data['gt_mme']
...
def APE():
    ...
    # load data
    Lnet_est_pose = np.load(f"./pcd_save/room0_0/GSsetup_Lnet_est_pose_eval.npy")
    Initial_pose = np.load(f"./pcd_save/room0_0/Initial_pose.npy")
